...
export type RabbitMqEventConsumerConfig = Readonly<{
  queue: string;
  eventBindings?: EventBinding[];
}>;

export class RabbitMqEventConsumer extends EventConsumer {
  ...
  constructor(
    ...
    protected readonly config: RabbitMqEventConsumerConfig,
    logger: EventLogger,
  ) {
    super(logger);
  }
